...
const router = require("./src/Routes/routes"); // used to handle routes
...
app.use(router);
const uri="mongodb+srv://OsamaAmr:ZGwOfSDP3lkb7zxg@cluster0.wau8kxm.mongodb.net/?retryWrites=true&w=majority";
class Database {
  constructor() {
    this._connect()
  }
